...
const Gameresult = ({gameresult}) => {
  ...
  return (
    <>
    {(gameresult===0)?
      <div className='text-white text-3xl w-fit mx-auto opacity-0'><div className='flex'><div className='w-10 h-12 rounded-full border-solid border-white border-8 justify-center items-center'></div> 
